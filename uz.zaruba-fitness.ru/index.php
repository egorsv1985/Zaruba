...
$APPLICATION->SetPageProperty("description", "У нас есть всё для твоих эффективных тренировок ✔️ 5 минут от метро Юго-Западная ✔️ Зал единоборств и кроссфита ✔️ Тренировки без покупки клубных карт!");
$APPLICATION->SetPageProperty("title", "Фитнес клуб Zaruba Fitness на Юго-Западе Москвы");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_TYPE" => "us",	// Тип информационного блока (используется только для проверки)
...
$APPLICATION->IncludeFile($APPLICATION->GetCurDir() . "include/tickers1.php", array(), array(
	"MODE" => "php",
	"NAME" => "лент",
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PARENT_SECTION_CODE" => "",
		"PREVIEW_TRUNCATE_LEN" => "",
		"PROPERTY_CODE" => array("BG_COLOR", "COLOR", ""),
		"SET_BROWSER_TITLE" => "N",
		"SET_LAST_MODIFIED" => "N",
		"SET_META_DESCRIPTION" => "N",
		"SET_META_KEYWORDS" => "N",
