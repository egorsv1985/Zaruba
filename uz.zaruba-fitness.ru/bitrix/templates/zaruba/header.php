...
<head>
	...
	<script>
		...
		})(window, document, 'script', 'dataLayer', '<?= \Victory\Options\CVictoryOptions::getOptionValue('gtm_' . SITE_ID); ?>');
	</script>
...
<body class="bg-black">
	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=<?= \Victory\Options\CVictoryOptions::getOptionValue('gtm_' . SITE_ID); ?>" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
