(() => {
  ...
  function G(e) {
    ...
    for (
      ...
      void 0 !== d[e + t]
        ? h >= d[e] && h < d[e + t] && ((m = e), (v = d[e + t] - d[e]))
        : h >= d[e] && ((m = e), (v = d[d.length - 1] - d[d.length - 2]));
    }
    let g = null,
      w = null;
    r.rewind &&
  ...
  class Y {
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: s } = this,
        i = m(f(t, `.${s.slideClass}, swiper-slide`)[0]);
      return m(e) - i;
    }
